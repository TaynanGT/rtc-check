...
# Regras liberadas em cada recurso. RTC001 e RTC002 são o corte de agosto em si
# e ficam no plano gratuito: é o que faz a ferramenta valer para todo mundo.
REGRAS_GRATUITAS = frozenset({"RTC001", "RTC002"})
