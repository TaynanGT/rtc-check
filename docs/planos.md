...
comprou. Se você só quer saber se vai ter nota rejeitada em agosto, nada disso é
necessário: `rtc-check ./xmls` responde isso de graça e para sempre.
...
| Regras `RTC001` e `RTC002` | sim | sim |
